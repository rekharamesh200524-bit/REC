...
<head>
  ...
  <title>INET - HRMS | Reset Password - 2026</title>
    ...
    <div class="form-shell">
      ...
      <div class="mobile-brand">
        ...
        <div>
          ...
          <div class="brand-tag">Recruitment Management</div>
        </div>
      </div>
      ...
      <form action="<?php echo base_url('admin/ResetPassword/' . $token); ?>" method="post">
        ...
        <div class="field">
          ...
          <div class="iw">
            ...
            <input type="password" id="NewPassword" name="NewPassword" placeholder="Minimum 6 characters" required minlength="6">
            <button type="button" class="tpw" aria-label="Show password" onclick="togglePw('NewPassword', this)">
        ...
        <div class="field">
          ...
          <div class="iw">
            ...
            <button type="button" class="tpw" aria-label="Show password" onclick="togglePw('ConfirmPassword', this)">
              <i class="fas fa-eye"></i>
            </button>
          </div>
        </div>

        <button type="submit" class="btn-submit mt-2rem">
